...
public class MemberRepositoryTest {
    ...
    void membeRepo_1() throws Exception {
        //given
        Member member = memberRepository.findFavoriteById(1L).get();
...
//        MemberForm memberForm = new MemberForm(null, "street", "111111citycode", name, nickname, "123", email, false, 10, jobs1, 1000);
        ...
        Member member = memberRepository.findMoneyAndJobById(userId).orElseThrow(() -> new IllegalStateException("존재하지 않은 아이디입니다."));
    ...
    void start_4() throws Exception {
        //given
        Member member = memberRepository.findMemberJobStorageMoneyById(15L)
                .orElse(memberRepository.findMoneyAndJobById(15L)
