...
public class WebServerCustomizer implements WebServerFactoryCustomizer<ConfigurableWebServerFactory> {
    ...
    public void customize(ConfigurableWebServerFactory factory) {
        final ErrorPage errorPage404 = new ErrorPage(HttpStatus.NOT_FOUND, "/error-page/404");
        final ErrorPage errorPage500 = new ErrorPage(HttpStatus.INTERNAL_SERVER_ERROR, "/error-page/500");
        final ErrorPage errorPageException = new ErrorPage(RuntimeException.class, "/error-page/500");
